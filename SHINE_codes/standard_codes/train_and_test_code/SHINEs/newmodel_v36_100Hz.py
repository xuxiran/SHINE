...
class Extractor(nn.Module):
    def __init__(self, input_channels=128*2):
        super(Extractor, self).__init__()
        self.convs1 = nn.Conv1d(128*3, 128, 1)
        self.convt1 = nn.Conv1d(128*4, 128*4, 12,groups=128*4)

        self.convs2 = nn.Conv1d(128*4, 128, 1)
        self.convt2 = nn.Conv1d(128*4, 128*4, 12,groups=128*4)

        self.convs3 = nn.Conv1d(128*4, 128, 1)
        self.convt3 = nn.Conv1d(128*4, 128*4, 12,groups=128*4)

        self.convs4 = nn.Conv1d(128*4, 128, 1)
        self.convt4 = nn.Conv1d(128*4, 128*4, 12,groups=128*4)

        self.conv5 = nn.Conv1d(128*4, 128*2, 12)
...
class OutputContext(nn.Module):
    def __init__(self, input_channels=128):
        ...
        self.conv = nn.Conv1d(input_channels, 128, 64)
...
class SHINE(nn.Module):
    def __init__(self, nb_blocks=6,emb = 64, output_dim=1):
        ...
        self.linear_layer = nn.Linear(128*2, 128)
